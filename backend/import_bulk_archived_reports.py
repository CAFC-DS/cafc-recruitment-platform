...
# Excel file path
EXCEL_FILE = "/Users/hashim.umarji/Downloads/ReportsNEw.xlsx"
...
def create_scout_if_not_exists(conn, cursor, scout_name, all_scouts_cache):
    ...
    try:
        ...
        if result:
            ...
            print(f"    ✓ Created scout user: {scout_name} (username: {username}, ID: {new_user_id})")
            return new_user_id, None
        else:
            return None, f"Failed to retrieve created user: {scout_name}"

    except Exception as e:
        print(f"    ✗ Error creating scout user '{scout_name}': {str(e)}")
    ...
    for idx, row in reports_df.iterrows():
        ...
        try:
            ...
            if was_created:
                ...
                # Duplicate - skip it
                print(f"  ⊘ Row {row_num}: Skipped duplicate report for {player_name}")
                continue
